...
if(er == 1){
  save(dat.merged.multiple, file = paste0("/n/dominici_nsaph_l3/Lab/projects/wildfires-hospitalizations-glm/model_run/data/feols/er/pop_weighted_temp/medicare_",gsub(" ", "_", causes_group),"_merged_data.RData"))
  
} else{
  save(dat.merged.multiple, file = paste0("/n/dominici_nsaph_l3/Lab/projects/wildfires-hospitalizations-glm/model_run/data/feols/total/pop_weighted_temp/medicare_",gsub(" ", "_", causes_group),"_merged_data.RData"))
}
